  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin_panel/users/create')}}">أضافة مستخدم جديدة</a></li>
      </ol>
    </section>
          ...
          <div class="box-body">
            <form action="">
             <div class="row">
               ...
               <div class="col-md-4">
                 <a href="{{Url('admin_panel/users/search')}}"></a>
            ...
            <tbody>
              ...
              <tr>
               ...
               <td class="text-center">
                <!-- <a href="{{url('admin_panel/users/'.$user->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a> -->
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h3 class="text-center "> هل أنت متأكد من حذف مستخدم  :  {{ $user->username }} ؟ </h3>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-outline"  data-dismiss="modal">الغاء</button>
                        <a href="{{url('admin_panel/users/'.$user->id.'/delete')}}" class="btn btn-outline danger delete pull-right">حذف</a>

   ...
   <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{Url('admin_panel/admins')}}">حسابات المستخدمين</a></li>
      </ol>
    </section>
    <!-- Main content -->
         ...
         <div class="box">
          ...
          {!!Form::open(array(
           ...
           <div class="form-group @if($errors->has('user_name')) has-error @endif">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" name="user_name" value="{{old('user_name')}}" placeholder="الاسم الاول">
